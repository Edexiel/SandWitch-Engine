...
private:
    ...
    std::string SelectInList(const std::vector<std::string>& list, const std::string& currentlySelected, const std::string& comboName);
    bool SelectTexture(Renderer::Texture& texture, const std::vector<std::string>& list, const std::string& currentTexture, const std::string& comboName);
};
